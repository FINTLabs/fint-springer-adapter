...
@Slf4j
@Repository
public class VariabellonnRepository extends SpringerRepository {
    ...
    public void accept(Event<FintLinks> response) {
        ...
        VariabellonnResource data = objectMapper.convertValue(response.getData().get(0), VariabellonnResource.class);
        ...
        if (response.getResponseStatus() == ResponseStatus.ACCEPTED) {
            create(VariabellonnResource.class, data);
