...
@Slf4j
@Repository
public class FasttilleggRepository extends SpringerRepository {
    ...
    public void accept(Event<FintLinks> response) {
        ...
        FasttilleggResource data = objectMapper.convertValue(response.getData().get(0), FasttilleggResource.class);
        ...
        if (response.getResponseStatus() == ResponseStatus.ACCEPTED) {
            create(FasttilleggResource.class, data);
